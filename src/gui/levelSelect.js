App.setupLevelSelect = function(){
	...
	var startLevel = function(lvlStr, id){
	...
	var addLevel = function(title, id, level){
		var btn = new App.GuiTextButton(15+172*xOffset,56+28*yOffset,timeOffset+200,timeOffset,title,function(){startLevel(level, id);},false,null,null);
		++xOffset;
		if(xOffset > 2){
			xOffset = 0;
			++yOffset;
	...
	addLevel("Moving"          , '536de1dc5d67b80b00ca1c4b', "move`0`9`5~2`2`0`8`I`random(0,10)~6`2`0`9`O`I`10");
	addLevel("Colors"          , '536de1f65d67b80b00ca1c4d', "move`0`9`9~2`2`0`8`A`random(0,10)~6`6`0`9`X`A`10~2`6`3`8`B`random(0,10)~6`2`3`9`Y`B`10");
	addLevel("Transferring"    , '536de21a5d67b80b00ca1c4f', "trans`0`9`5~2`2`0`8`I`random(0,10)~6`2`2`9`O`I`10"); // TODO: QUOTA 0 ON TOGGLES
	addLevel("Incrementing"    , '536de2325d67b80b00ca1c53', "increment`0`9`5~2`2`0`8`I`random(0,10)~6`2`0`9`O`I+3`10");
	addLevel("Sign Sort"       , '536de24a5d67b80b00ca1c55', "sgn`0`9`9~2`4`0`8`I`random(0,10)~6`2`0`9`X`I`10~6`6`0`9`Y`I`10"); // TODO: PUT NEW "SORTING" FUNCTIONALITY IN PARSER
	addLevel("Equality Sort"   , '536de2645d67b80b00ca1c57', "equal`0`9`9~2`2`0`8`A`random(0,10)~2`6`0`8`B`random(0,10)~6`4`0`9`O`A`10"); // TODO: PUT NEW "SORTING" FUNCTIONALITY IN PARSER
	...
	addSection("Easy");
	addLevel("Zeroing"         , '536de28d5d67b80b00ca1c59', "zero`0`9`5~2`2`0`8`I`random(0,10)~6`2`0`9`O`0`10");
	addLevel("Mod 2"           , '536de2a25d67b80b00ca1c5b', "mod 2`0`11`5~2`2`0`8`I`random(0,10)~8`2`0`9`O`I%2`10");

	addSection("Medium");
	addLevel("Negation"        , '536de2b65d67b80b00ca1c5d', "negate`0`9`5~2`2`0`8`I`random(0,10)~6`2`0`9`O`-I`10");
	addLevel("Absoluting"      , '536de2cf5d67b80b00ca1c5f', "abs`0`9`5~2`2`0`8`I`random(0,10)~6`2`0`9`O`abs(I)`10");
	addLevel("Rounding"        , '536de2e25d67b80b00ca1c61', "round`0`11`5~2`2`0`8`I`random(0,100)~8`2`0`9`O`round(I/10)*10`10");
	addLevel("Addition"        , '536de2f65d67b80b00ca1c63', "add`0`11`11~2`2`0`8`A`random(0,10)~2`8`1`8`B`random(0,10)~8`5`2`9`O`A+B`10");
	addLevel("Subtraction"     , '536de3695d67b80b00ca1c65', "sub`0`11`11~2`2`0`8`A`random(0,10)~2`8`1`8`B`random(0,10)~8`5`2`9`O`A-B`10");
	addLevel("Division"        , '536de37b5d67b80b00ca1c69', "div`0`11`11~2`2`0`8`A`random(0,128)~2`8`1`8`B`random(0,10)~8`5`2`9`O`A/B`10");
	addLevel("Modding"         , '536de3935d67b80b00ca1c6d', "mod`0`11`11~2`2`0`8`A`random(0,128)~2`8`1`8`B`random(0,10)~8`5`2`9`O`A%B`10");
	addLevel("Multi-Out Sort"  , '536de58b5d67b80b00ca1c71', "msort`0`11`5"); // TODO: IMPLEMENT THIS

	addSection("Hard");
	addLevel("Multiplication"  , '536de6035d67b80b00ca1c75', "multiply`0`11`11~2`5`3`8`Z`0~5`2`0`8`A`random(0,10)~5`8`1`8`B`random(0,10)~8`5`2`9`O`A*B`10");
	addLevel("Squaring"        , '536de61e5d67b80b00ca1c77', "square`12342`11`11~2`2`0`8`I`random(1,12)~2`8`1`8`Z`0~8`5`2`9`O`I*I`10");
	addLevel("Cubing"          , '536de65c5d67b80b00ca1c79', "cube`456`11`11~2`2`0`8`I`random(1,6)~2`8`1`8`Z`0~8`5`2`9`O`I*I*I`10");
	addLevel("Factorial"       , '536de6745d67b80b00ca1c7b', "fact`12344`11`11~2`2`0`8`I`random(1,6)~2`8`1`8`Z`0~8`5`2`9`O`fac(I)`10");
	addLevel("Single-Out Sort" , '536de6915d67b80b00ca1c7d', "ssort`0`11`5"); // TODO: IMPLEMENT THIS
