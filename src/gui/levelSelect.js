App.setupLevelSelect = function(){
	...
	addLevel("Move"            , "moving`0`9`5~2`2`0`8`I`random(0,10)~6`2`0`9`O`I`10");
	addLevel("Increment"       , "increment`0`9`5~2`2`0`8`I`random(0,10)~6`2`0`9`O`I+3`10");
	...
	addLevel("Multiplication"  , "multiply`0`0`0~2`5`3`8`Z`0~5`2`0`8`A`random(0,10)~5`8`1`8`B`random(0,10)~8`5`2`9`O`A*B`10");
