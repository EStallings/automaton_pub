...
function test6(){
	var testLevel = new App.SimulationLevel(7,6);
	...
	new App.SimulationInstruction(testLevel,1,2,3,2);
	...
	new App.SimulationInstruction(testLevel,2,4,2,7);
	new App.SimulationInstruction(testLevel,4,1,1,5);
	new App.SimulationInstruction(testLevel,4,4,2,4);
